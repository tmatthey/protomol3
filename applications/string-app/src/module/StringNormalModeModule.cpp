...
void StringNormalModeModule::init(ProtoMolApp *app) {
  ...
  app->integratorFactory.registerExemplar(new NormalModeStringDiag());
  app->integratorFactory.registerExemplar(new NormalModeMori());
  app->integratorFactory.registerExemplar(new NormalModeSubspaceSampling());
  app->integratorFactory.registerExemplar(new NormalModeRelax());
  app->integratorFactory.registerExemplar(new NormalModeBrownian());
  app->integratorFactory.registerExemplar(new NormalModeFERelax());
  app->integratorFactory.registerExemplar(new NormalModeFEBrownian());
...
void StringNormalModeModule::read(ProtoMolApp *app) {
