...
namespace ProtoMol {
  ...
  public:
    ...
    static ParallelType getMode()      {return myMode;}

    static void setMode(ParallelType mode);

    static bool isDynamic()            {return myMode != ParallelType::STATIC;}

    static int getPipeSize()           {return myPipeSize;}

    static void setPipeSize(int n);

    static bool isBarrier()            {return myUseBarrier;}

    static void setBarrier(bool b)     {myUseBarrier = b;}

    static int getMaxPackages()       {return myMaxPackages;}

    static void setMaxPackages(int n);
  ...
  public:
    ...
    static void send(Real *data, int num, int address);
