...
namespace ProtoMol {
  ...
  public:
    ...
    const_iterator begin() const {return myBeginConst;}
    const_iterator end()   const {return myEndConst;}
  ...
  public:
    ...
    void updateCache();
    void uncache() {valid = false;}

    int getDimX() const {return myNX;}
    int getDimY() const {return myNY;}
    int getDimZ() const {return myNZ;}
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // My data members
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  public:
