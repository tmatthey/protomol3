...
void GBACEForce::getParameters(vector<Parameter> &parameters) const {
     parameters.push_back(
        Parameter("-solvationparam",Value(sigma, ConstraintValueType::NoConstraints()),(Real) (2.26 / 418.4), Text("solvation parameter")));
        //kJ nm^{-2} -> KCal \AA^{-2} 1/418.4
     parameters.push_back(
        Parameter("-watersphereradius",Value(rho_s, ConstraintValueType::NoConstraints()), (Real) 1.4, Text("solvation parameter")));
}
