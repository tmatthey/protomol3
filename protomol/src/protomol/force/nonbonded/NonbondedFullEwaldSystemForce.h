...
namespace ProtoMol {
  ...
  class NonbondedFullEwaldSystemForce: public SystemForce, private NonbondedFullEwaldSystemForceBase {
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Typedef
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  private:
  ...
  private:
    Force* doMake(const std::vector<Value>& values) const{
        Real alpha           = values[0];
        Real accuracy        = values[1];
        Real expansionFactor = (TBoundaryConditions::VACUUM?(Real)values[2]:(Real)3.0);
        std::string err      = "";
  ...
  std::string NonbondedFullEwaldSystemForce<TBoundaryConditions,
    ...
    return (CoulombForce::keyword + " -algorithm "+ keyword + 
