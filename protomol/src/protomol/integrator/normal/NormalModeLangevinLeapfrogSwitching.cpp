...
namespace ProtoMol {
  ...
  void NormalModeLangevinLeapfrogSwitching::getParameters(vector<Parameter>& parameters) const {
    ...
    parameters.push_back(Parameter("gammaInside",Value(myGammaInside*(1000 * Constant::INV_TIMEFACTOR),ConstraintValueType::NotNegative()),(Real) 80.0,Text("Langevin Gamma")));
    parameters.push_back(Parameter("gammaOutside",Value(myGammaInside*(1000 * Constant::INV_TIMEFACTOR),ConstraintValueType::NotNegative()),(Real) 80.0,Text("Langevin Gamma")));
